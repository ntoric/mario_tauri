...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
    return Order(
      ...
      tableId: json['tableId']?.toString() ?? json['table_id']?.toString() ?? '',
      ...
      orderType: json['orderType']?.toString() ?? json['order_type']?.toString() ?? 'dine_in',
    );
  }
  ...
  bool get isParcel => orderType == 'parcel';
